...
鱼皮会帮助星球的同学免费修改求职简历（已修改 400 多份），帮你的简历提升一个档次，并给你接下来的学习建议。
...
星球已经有近 50 期直播，直播内容包括但不限于：从 0 到 1 开发完整项目，编程学习 + 竞赛项目 + 求职面试 + 职场晋升等经验。通过直播，不仅能带你做出自己的完整项目，还能帮助你掌握独立开发项目的能力（项目是求职面试中的核心）。

目前第三期项目正在进行，手把手带大家开发一个开放式 API 接口平台（网上无类似视频教程、写简历上也是很加分的）。
